...
date: 2026-02-04
slug: blog/20260204-playwright-trouble-shooting
authors: [indigo]
tags: [Playwright, Testing, Firefox, WSL, Troubleshooting]
description: WSL2環境でPlaywrightを導入した際にFirefoxだけテストが落ちた問題の解決記録。Syntax ErrorやMissingDependencyなどのエラー原因を特定し、WSLでの開発者が参考にできるトラブルシューティングプロセスを詳解します。
featured: false
draft: false
