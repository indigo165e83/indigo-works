...
WSL2環境では、システムのPythonではなくpyenvで管理することを強く推奨します。
...
cp ~/ml_projects/outputs/cookie_lora/cookie_lora.safetensors \
   /mnt/d/creative/061_StabilityMatrix/Data/Models/Lora/

cp ~/ml_projects/models/realisticVisionV60B1_v51HyperVAE.safetensors \
   /mnt/d/creative/061_StabilityMatrix/Data/Models/StableDiffusion/
```
