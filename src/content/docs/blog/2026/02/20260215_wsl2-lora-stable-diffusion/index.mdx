---
title: WSL2環境でペット専用LoRAを訓練してStable Diffusionで画像生成するまでのまとめ
date: 2026-02-15
slug: blog/20260215_wsl2-lora-stable-diffusion
description: 愛するペットの写真からAI画像生成用のLoRAモデルを作成し、オリジナル画像を生成するまでの技術的な手順を詳しく解説します。
author: 'indigo'
tags: ['AI', 'Machine Learning', 'Stable Diffusion', 'LoRA', 'WSL2', 'Deep Learning']
---

## はじめに

この記事では、ペット（うさぎ）のクッキーの写真から専用のLoRAモデルを訓練し、Stable Diffusionで画像生成するまでの全工程を解説します。
...
2. Stable Diffusion WebUIパッケージをインストール
3. LoRAファイルとベースモデルを配置
...
*クッキーが2匹。物理法則が少し怪しげです。*

![Generated Cookie Image](2026-02-15/00001-2122136207.png)
*こちらもクッキーがまだ2匹。親子・・・？*

クッキー毛の質感や模様がリアルに再現されているのはGoodですが、物理法則が少し怪しげです。かわいさも足りないです。
