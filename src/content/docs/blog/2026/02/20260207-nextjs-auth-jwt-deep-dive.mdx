...
date: 2026-02-07
slug: blog/20260207-nextjs-auth-jwt-deep-dive
authors: [indigo]
tags: [Next.js, Auth.js, セキュリティ, JWT]
description: Auth.js（NextAuth）を例にJWTの仕組みをわかりやすく解説。「パスポートと搭乗券」のたとえで認証フローを直感的に理解し、デバッグ品質を高めるための現場で使えるTipsをまとめました。
featured: true
draft: false
...
追記：
[JSON Web Token（JWT）デバッガー](https://www.jwt.io/ja/) で実際のJWTを貼り付けると、各パーツの中身を簡単に確認できます。
