...
9.1 [ソート — sorted, sort, operator](chapter-09/09-01)  
9.2 [さまざまなコンテナデータ型を扱う — collections](chapter-09/09-02)  
9.3 [二分法アルゴリズムを利用する — bisect](chapter-09/09-03)  
9.4 [列挙型による定数の定義を行う — enum](chapter-09/09-04)  
9.5 [データを読みやすい形式で出力する — pprint](chapter-09/09-05)  
9.6 [イテレーターの組み合わせで処理を組み立てる — itertools](chapter-09/09-06)  
9.7 [ミュータブルなオブジェクトをコピーする — copy](chapter-09/09-07)  
